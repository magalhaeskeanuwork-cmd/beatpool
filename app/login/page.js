      ...
      <div className="hidden md:flex flex-col justify-between w-1/2 bg-red-600 p-16">
        ...
        <div>
          <h2 className="text-6xl font-black uppercase tracking-tighter leading-none text-white mb-6">
            YOUR<br />VISION.<br />THEIR<br />BEATS.
          </h2>
        ...
        <div className="max-w-sm w-full mx-auto">
          ...
          <div className="space-y-4">
            {isSignup && (
              <>
                <div>
                  <label className="text-xs uppercase tracking-widest text-white/30 block mb-2">Username</label>
                  <input
                    type="text"
                    value={username}
                ...
                <div>
                  <label className="text-xs uppercase tracking-widest text-white/30 block mb-2">Legal name</label>
                  <input
                    type="text"
                    value={legalName}
          ...
          {error && <p className="text-red-400 text-xs uppercase tracking-widest mt-4">{error}</p>}
          {message && <p className="text-green-400 text-xs uppercase tracking-widest mt-4">{message}</p>}
